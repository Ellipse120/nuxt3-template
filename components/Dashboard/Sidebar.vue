<template>
  <div
    ref="sidebar"
    :class="{
      'fixed top-0 hidden pt-16 lg:flex lg:w-60 xl:w-80 h-screen': mode === 'normal',
    ...
    <div class="flex-1 overflow-y-auto pl-4 lg:pl-0 pr-4 py-4">
      <ul>
        <li v-for="i in 29" :key="i">
          <CustomAnchor :to="{ name: 'dashboard' }" class="group flex items-center mb-4 hover:no-underline">
            <div
